...
export default class Map extends React.Component{
    componentDidMount(){
        ...
        L.marker([-27.4494,-58.7577],{icon:llegada}).addTo(this.map).bindPopup("Punto de retiro");
        L.marker([-28.3216,-57.3691],{icon:observacion}).addTo(this.map).bindPopup("Punto de observacion");
    }
