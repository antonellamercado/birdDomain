...
export default class Map extends React.Component{
    componentDidMount(){
        ...
        L.marker([-54.8394,-63.3122],{icon:llegada}).addTo(this.map).bindPopup("Punto de retiro");
        L.marker([-58.8430,-68.5538],{icon:observacion}).addTo(this.map).bindPopup("Punto de observacion");
    }
