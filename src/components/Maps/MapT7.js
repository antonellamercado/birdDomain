...
export default class Map extends React.Component{
    componentDidMount(){
        ...
        L.marker([-32.8275,-68.7983],{icon:llegada}).addTo(this.map).bindPopup("Punto de retiro");
        L.marker([-32.879,-68.9130],{icon:observacion}).addTo(this.map).bindPopup("Punto de observacion");
    }
