...
export default class Map extends React.Component{
    componentDidMount(){
        ...
        L.marker([-24.8439,-65.4783],{icon:llegada}).addTo(this.map).bindPopup("Punto de retiro");
        L.marker([-25.2341,-65.9475],{icon:observacion}).addTo(this.map).bindPopup("Punto de observacion");
    }
